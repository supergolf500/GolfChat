...
public class ItemMessageViewHolder_A extends RecyclerView.ViewHolder  implements View.OnClickListener {
    ...
    public ItemMessageViewHolder_A(View itemView,Context ctx) {
        super(itemView);
