...
public class ItemMessageViewHolder_GPS_A extends RecyclerView.ViewHolder  implements View.OnClickListener,OnMapReadyCallback {
    private Context ctx;
    ...
    public ItemMessageViewHolder_GPS_A(View itemView, Context ctx,String FriendName) {
        super(itemView);
