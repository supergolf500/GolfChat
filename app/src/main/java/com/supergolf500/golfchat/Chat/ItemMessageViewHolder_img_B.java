...
public class ItemMessageViewHolder_img_B extends RecyclerView.ViewHolder  implements View.OnClickListener {
    ...
    public ItemMessageViewHolder_img_B(View itemView, Context ctx) {
        super(itemView);
